...
CREATE TABLE Customer (id INT NOT NULL IDENTITY(1,1), google_id NVARCHAR(MAX) NOT NULL, email NVARCHAR(50) NOT NULL, first_name NVARCHAR(50) NOT NULL, last_name NVARCHAR(50) NOT NULL,
